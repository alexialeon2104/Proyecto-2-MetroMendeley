    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        try {
          if (authorsList.searchAuthor((String) authorNames.getSelectedItem()) != null) {
            ...
            LinkedList articles = author.getArticles();
            
            SelectAuthorSummaryUI selectAuthor = new SelectAuthorSummaryUI(this, articles, author.getName());
            }  
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Debe escoger uno de los autores");
        }
